...
- [ ] **T5.2** Plot-function feed rewiring (game geometry → DrawCommand list) — [T5.2](T5.2-plot-function-feed-rewiring.md) *(terrain/tile core + DrawGame dx11 consumer + texture baking + in-game A/B verified + cars body/wheels + MODEL sprites/effects submitted: [core](T5.2-terrain-tile-core.md), [consumer](T5.2-dx11-consumer-drawgame.md), [texture](T5.2-feed-texture-baking.md), [A/B](T5.2-ab-verify-in-game.md), [cars](T5.2-car-feed.md), [sprite/sky/effects](T5.2-sprite-sky-effects.md))*
