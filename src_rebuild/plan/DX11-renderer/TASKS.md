...
- [ ] **T5.2** Plot-function feed rewiring (game geometry → DrawCommand list) — [T5.2](T5.2-plot-function-feed-rewiring.md) *(terrain/tile core + DrawGame dx11 consumer + texture baking done: [core](T5.2-terrain-tile-core.md), [consumer](T5.2-dx11-consumer-drawgame.md), [texture](T5.2-feed-texture-baking.md))*
