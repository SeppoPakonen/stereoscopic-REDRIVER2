...
- [x] **T1.8** DX11 audio: XAudio2 module + harness — [T1.8](T1.8-dx11-audio-xaudio2.md)

## Phase 2 — Stereo natively (M2)

- [x] **T2.1** Per-eye render targets — [T2.1](T2.1-per-eye-render-targets.md)
- [x] **T2.2** Per-eye projection (yaw-derived lateral offset) — [T2.2](T2.2-per-eye-projection.md)
- [x] **T2.3** SBS/TB composite in the renderer — [T2.3](T2.3-sbs-tb-composite.md)
- [x] **T2.4** Verify right-eye map issue is gone — [T2.4](T2.4-verify-right-eye-issue-gone.md)

## Phase 3 — Color modes & split-screen (M3)

- [x] **T3.1** Shader-based composite color modes — [T3.1](T3.1-shader-composite-color-modes.md)
- [x] **T3.2** Split-screen — [T3.2](T3.2-split-screen.md)
- [x] **T3.3** Higher internal resolution option — [T3.3](T3.3-higher-internal-resolution-option.md)
...
- [x] **T4.2** Keep legacy `psyx` path selectable — [T4.2](T4.2-keep-psyx-selectable.md)
...
- [ ] **T5.2** Plot-function feed rewiring (game geometry → DrawCommand list) — [T5.2](T5.2-plot-function-feed-rewiring.md) *(terrain/tile core + DrawGame dx11 consumer + texture baking + in-game A/B verified + cars body/wheels + MODEL sprites/effects + sky submitted: [core](T5.2-terrain-tile-core.md), [consumer](T5.2-dx11-consumer-drawgame.md), [texture](T5.2-feed-texture-baking.md), [A/B](T5.2-ab-verify-in-game.md), [cars](T5.2-car-feed.md), [sprite/sky/effects](T5.2-sprite-sky-effects.md))*
